...
$items = @("GoogleChrome", "filezilla", "notepadplusplus", "foxitreader", "wireshark", "winscp", "jing", "terminals", "digsby", "vlc", "vmsphereclient", "mysql.workbench", "git", "windowsazurepowershell")
